...
import { Tv2, Mail, Lock, Eye, EyeOff, ArrowLeft } from 'lucide-react';
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none z-0 overflow-hidden">
        ...
        />
        <div className="absolute top-1/4 left-1/4 w-[500px] h-[500px] bg-indigo-600/5 rounded-full blur-[120px] animate-pulse-slow" />
        <div className="absolute bottom-1/4 right-1/4 w-[400px] h-[400px] bg-cyan-500/5 rounded-full blur-[100px] animate-pulse-slow" />
      </div>
        ...
        <div className="w-full max-w-md bg-slate-900/40 border border-white/10 backdrop-blur-xl rounded-2xl p-8 shadow-2xl shadow-indigo-500/5 hover:border-indigo-500/20 transition-all duration-300 animate-fade-in">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-xs sm:text-sm text-slate-400">
              Masuk untuk melanjutkan pelacakan media Anda
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <div className="flex items-center justify-between mb-1.5">
                ...
                <a
                  ...
                  onClick={(e) => {
                    e.preventDefault();
                    alert('Lupa password tidak diimplementasikan demi kemudahan pengujian.');
                  }}
            ...
            <div className="flex items-center">
              <input
                ...
                className="w-4 h-4 rounded border-slate-700 bg-slate-900 text-indigo-600 focus:ring-indigo-500/30 focus:ring-offset-0 focus:ring-2 cursor-pointer"
              />
